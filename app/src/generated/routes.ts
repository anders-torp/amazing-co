...
export function RegisterRoutes(app: express.Express) {
    ...
    app.get('/node/:nodeId/height',
        function(request: any, response: any, next: any) {
            ...
            const promise = controller.getHeight.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/node/:nodeId/root',
        function(request: any, response: any, next: any) {
            const args = {
                nodeId: { "in": "path", "name": "nodeId", "required": true, "dataType": "double" },
            };
            ...
            const promise = controller.getRoot.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/node/:nodeId/children',
        function(request: any, response: any, next: any) {
            ...
            const promise = controller.getChildren.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.post('/node/:nodeId/parent/:parentId',
        function(request: any, response: any, next: any) {
            const args = {
                nodeId: { "in": "path", "name": "nodeId", "required": true, "dataType": "double" },
            ...
            const promise = controller.changeParent.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.post('/node',
        function(request: any, response: any, next: any) {
            ...
            const promise = controller.newNode.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
